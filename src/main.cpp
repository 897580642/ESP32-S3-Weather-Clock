...
const char *SENIVERSE_KEY = "SoGP5QV40infsGPIt";//心知天气秘钥,替换成自己的秘钥
const char *SENIVERSE_LOCATION = "beijing";//城市列表 https://docs.seniverse.com/api/start/start.html,替换成自己的城市名称
...
void setup(void) {
    ...
    sprintf(stWeather.location, "%s", "Beijing");
